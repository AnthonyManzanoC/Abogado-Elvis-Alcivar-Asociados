...
export const fallbackData: BootstrapData = {
  settings: {
    ...
    map_embed_url: "",
    map_query: "",
    map_load_on_click: true,
    office_directions: "",
    contact_heading: "Hablemos con claridad sobre tu situación.",
    contact_intro: "Comparte la información inicial mediante la agenda. El detalle sensible del caso se revisará de forma privada durante la consulta.",
    whatsapp_message: "Hola, quisiera información para agendar una consulta legal.",
