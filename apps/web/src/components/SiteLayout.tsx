    ...
    <div className="site-shell">
      ...
      <footer className="site-footer">
        ...
        <div className="footer-grid">
          ...
          <div><strong>Despacho</strong><p>{settings.office_address}</p><p>{settings.office_hours_note}</p></div>
          <div><strong>Conecta</strong><a href={settings.instagram_url} target="_blank" rel="noreferrer"><Instagram size={16} /> Instagram</a><a href={settings.tiktok_url} target="_blank" rel="noreferrer">TikTok</a></div>
        </div>
      ...
      {whatsapp && <a className="floating-whatsapp" href={`https://wa.me/${whatsapp}`} target="_blank" rel="noreferrer" aria-label="Contactar por WhatsApp"><MessageCircle /></a>}
    </div>
  );
}
